      ...
      <main className="">
        ...
        <section className="m-4 my-24">
          <div className="mx-auto xl:container sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 text-pretty md:gap-16">
            ...
            <div className="mb-12 mt-32 lg:mt-0 lg:mb-0 lg:aspect-square w-full place-content-center md:order-4">
              ...
              <p className="leading-7 tracking-wide mt-1">
                Enjoy them on their own or mix them into salads and smoothies for a nutrient boost. They make fantastic toppers for
                sandwiches and add a burst of flavor as a garnish or decoration for your plates.
              </p>
            </div>
            <img
        ...
        <section id="benefits" className="m-4">
          <div className="lg:container mx-auto sm:px-6 lg:px-8">
            <div className="mb-8">
              <h2 className="mb-1 scroll-m-2>0 pb-2 text-3xl font-semibold tracking-tight first:mt-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-16">
              ...
              <div className="5 md:flex">
                ...
                <div className="">
                  ...
                  <p className="body1">
                    Chefs use the many different coloured and flavoured microgreens to intensify flavour or add visual impacts to their
                    meals. .
                  </p>
                </div>
              </div>
