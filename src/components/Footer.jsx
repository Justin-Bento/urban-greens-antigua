        ...
        <footer className="px-4 py-20 text-white bg-green-600">
          <div className="mx-auto max-w-7xl">
            <div className="grid grid-cols-2 gap-4 mb-3 md:grid-cols-5">
              <a href="/" title="Go to Kutty Home Page" className="col-span-2 md:col-span-1">
                <img
              ...
              <nav className="mb-8">
                <p className="mb-3 text-xs font-bold tracking-wider text-gray-50 uppercase">Product</p>
              ...
              <nav className="mb-8">
                <p className="mb-3 text-xs font-bold tracking-wider text-gray-50 uppercase">Contact</p>
                <a href="#" className="flex mb-3 text-sm font-medium transition md:mb-2 hover:text-primary">
                  Twitter
                </a>
                <a href="#" className="flex mb-3 text-sm font-medium transition md:mb-2 hover:text-primary">
              ...
              <nav className="mb-8">
                <p className="mb-3 text-xs font-bold tracking-wider text-gray-50 uppercase">Legal</p>
                <a href="#" className="flex mb-3 text-sm font-medium transition md:mb-2 hover:text-primary">
                  Terms of Service
                </a>
                <a href="#" className="flex mb-3 text-sm font-medium transition md:mb-2 hover:text-primary">
                ...
                <a href="#" className="flex mb-3 text-sm font-medium transition md:mb-2 hover:text-green-70">
                  Cookie Policy
                </a>
                <a href="#" className="flex mb-3 text-sm font-medium transition md:mb-2 hover:text-green-70">
                  Affiliate Program
